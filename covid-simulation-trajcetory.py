...
def create_tsgraphs():
    ...
    for x in graphstamps:
        ...
        fp = open("images/graphP"+ str((TS*i)) +".json", "w")
        fg = open("images/graphG"+ str((TS*i)) +".json", "w")
    ...
    fPGraph = open("images/graphP.json", "w")
    for u,v in P.edges():
        col = P[u][v]['color']
        w = P[u][v]['weight']
    ...
    fGraph = open("images/graphG.json", "w")
    for u,v in G.edges():
